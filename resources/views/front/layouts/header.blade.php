...
<head>
    <title>Hospital Management</title>
     <link rel="icon" href="{{asset('front/img/logo.png')}}" type="img"/ style="height: 150px; width: 150px;">
    <meta charset="UTF-8">
...
<div class="icon"><span class="flaticon-customer-service"></span></div>
  <a class="phone" href="#" style="color: white;">Phone</a>
</div>
</div>
  <div class="social">
<ul>
<li style="color: white;"><a href="{{Route('login')}}" target="_blank" class="black" style="color: white;"><i class="fa fa-lg fa-sign-in" style="color: white;"> </i> Login</a> </li>
